...
class QubitInformationObject extends BaseInformationObject
{
  ...
  /**
   * Return URL to EAD XML or, in unpublished, action to generate XML.
   *
   * @return string  URL
   */
  ...
  {
    return arXmlExportSingleFileJob::getPath($this->id, 'ead', $contentsOnly);
  }

  /**
   * Return URL to DC XML or, in unpublished, action to generate XML.
   *
   * @param
   * @return string  URL
   */
